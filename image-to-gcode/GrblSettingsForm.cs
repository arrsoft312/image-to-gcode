...
partial class GrblSettingsForm:Form {
        ...
        foreach (object[] setting in settingsTable) {
            ...
            if ((int)setting[3] != 0) {
                ...
                if ((int)setting[4] != 0) {
                    ...
                    ((TextBox)setting[6]).Text = ((float)setting[2]).ToString();
                }
            }
        }
    ...
    public GrblSettingsForm() {
        ...
        settingsTable = new object[][] {
            ...
            new object[] { 18,  null, null, 1, 5, null,    checkBox14, checkBox15, new CheckBox(), new CheckBox(), checkBox25, },
            new object[] { 23,  null, null, 1, 2, null,    checkBox7, checkBox8, },
            new object[] { 19,  null, null, 1, 8, tableLayoutPanel11, checkBox9, checkBox10, new CheckBox(), new CheckBox(), checkBox11, checkBox13, new CheckBox(), new CheckBox(), },
            ...
            new object[] { 36,  null, null, 0, 0, label11, textBox3, },
            new object[] { 37,  null, null, 0, 0, label22, textBox30, },
            new object[] { 40,  null, null, 0, 0, label12, textBox21, },
            new object[] { 41,  null, null, 0, 0, label13, textBox22, },
            new object[] { 4,   null, null, 1, 1, null,    checkBox12, },
            new object[] { 7,   null, null, 1, 1, null,    checkBox17, },
            new object[] { 9,   null, null, 1, 1, null,    checkBox20, },
            new object[] { 8,   null, null, 1, 1, null,    checkBox18, },
            new object[] { 33,  null, null, 1, 1, null,    checkBox19, },
            new object[] { 35,  null, null, 1, 1, null,    checkBox23, },
            new object[] { 14,  null, null, 1, 1, null,    checkBox16, },
            new object[] { 34,  null, null, 1, 1, null,    checkBox22, },
            new object[] { 15,  null, null, 1, 1, null,    checkBox24, },
            new object[] { 16,  null, null, 1, 1, null,    checkBox21, },
        };
        
        foreach (object[] setting in settingsTable) {
            if ((int)setting[3] != 0) {
                for (int i = 0; i < (int)setting[4]; i++) {
                    ((Control)setting[6+i]).Tag = (int)setting[0];
                }
            } else {
                ((Control)setting[6]).Tag = (int)setting[0];
            }
        }
    }
}
